...
public class CommonUtil {
	...
	/**
	 * day を(String2文字)で返すで返す
	 */
	public static String dayFormatTwo(String day) {
	 ...
	 */
	public static boolean typeSQLCheck(String sqlType) {
	...
	/**
	 * value(Formの入力値)の値が記号やURLのときエスケープするメソッド
	 */
	public static String replaceEscapeChar(String value) {
	...
	public static List<ValidationBean> validInputAllStatus(List<UserInfoBean> userList) {
		...
		if(userList.get(0).getId() != null) {
			...
			beanList = CommonUtil.validIdStatus(id);
		...
		if(userList.get(0).getName() != null) {
			...
			beanList = CommonUtil.validNameStatus(name);
		...
		if(userList.get(0).getNameKana() != null) {
			...
			beanList = CommonUtil.validNameKanaStatus(nameKana);
		...
		if(userList.get(0).getGender() != null) {
			...
			beanList = CommonUtil.validGenderStatus(gender);
		...
		if(userList.get(0).getPassword() != null) {
			...
			beanList = CommonUtil.validPasswordStatus(password);
		...
		if(userList.get(0).getAddress() != null) {
			...
			beanList = CommonUtil.validAddressrStatus(address);
		...
		if(userList.get(0).getTel() != null) {
			...
			beanList = CommonUtil.validTelStatus(tel);
		...
		if(userList.get(0).getEmail() != null) {
			...
			beanList = CommonUtil.validEmailStatus(email);
		...
		if(userList.get(0).getNote() != null) {
			...
			beanList = CommonUtil.validNoteStatus(note);
		...
		if(userList.get(0).getDelFlag() != null) {
			...
			beanList = CommonUtil.validDelFlagStatus(delFlag);
